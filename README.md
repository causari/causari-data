...
GitHub Pages also publishes an evidence-first Event Explorer at `/explorer/`. It loads packs at runtime and exposes Timeline, Causal Map, Claims, Evidence, and Forecast views without requiring a separate frontend deployment.
